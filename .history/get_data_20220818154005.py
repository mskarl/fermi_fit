...
for item in enumerate(list(zip(my_table["4FGLName"].values, my_table["RA"].values, my_table["DEC"].values))):
    print(item)


for source_name, ra, dec in enumerate(list(zip(my_table["4FGLName"], my_table["RA"], my_table["DEC"]))):
